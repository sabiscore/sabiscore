...
- Updated `_META_MODEL_CALIBRATION_LABELS` in `prediction.py` to recognize `LogisticRegression` ("platt") and `_MetaModel` ("mock"), ensuring tests evaluating older artifacts correctly assert they are calibrated.
