...
class TestBUG001DrawCalibration:
    ...
    def test_ensemble_uses_isotonic_calibration(self):
        ...
        assert hasattr(model.meta_model, "method"), (
            "Meta model missing calibration method"
        )
    ...
    def test_draw_calibration_ratio_above_threshold(self):
        ...
        draw_calibration_ratio = (
            predicted_draw_rate / actual_draw_rate if actual_draw_rate > 0 else 0
        )
    ...
    def test_all_league_models_train_with_sample_weights(self):
        ...
        for LeagueModel in league_models:
            ...
            assert hasattr(league, "train"), (
                f"{LeagueModel.__name__} missing train method"
            )
            assert hasattr(league, "models"), (
                f"{LeagueModel.__name__} missing models dict"
            )
