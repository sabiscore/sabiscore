...
class LaLigaModel:
    ...
    def __init__(self, redis_client: redis.Redis):
        ...
        self.ensemble_weights = {"rf": 0.25, "xgb": 0.45, "lgbm": 0.20, "gb": 0.10}
    ...
    def extract_laliga_features(self, match_data: Dict) -> np.ndarray:
        ...
        features.extend(
            [0] * (87 - len(features))
        )  # Padding to 87 to match EPL count for consistency, though not strictly required if trained separately.
